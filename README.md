...
[![Maven Central](https://img.shields.io/maven-central/v/com.github.piasy/compose-webview-multiplatform.svg)](https://search.maven.org/artifact/com.github.piasy/compose-webview-multiplatform)
    ...
    sourceSets {
        commonMain {
            dependencies {
                ...
                api("com.github.piasy:compose-webview-multiplatform:2.1.2")
            }
        }
    }
}
